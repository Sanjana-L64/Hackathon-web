...
with col1:
    with st.container(border=True):
        ...
        Rse = st.number_input("Rse:Ohms", value=0.20, min_value=0.0)
        Ra = st.number_input("Ra Ohms", value=0.10, min_value=0.0)
        CL = st.number_input("CL:Watts", value=1.0, min_value=0.0)
